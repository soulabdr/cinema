                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                    <div class="accordion-body">
                                        <section>
                                                <div className='row '>
                                                    <div className='col-sm-6 text-start'>
                                                        <p>After selecting the Movie and Session, you must choose the ticket type. | If you are a student, do not forget to bring your ID card with you.</p>                        
                                                    </div>
                                                </div>
                                        ...
                                        <div className='col-sm-6 mb-2 text-end'>
                                            {ticketItem === "placeSection" ?
                                                <button className='btn btn-dark' data-bs-toggle="collapse" 
                                                    ...
                                                    onClick={() => {
                                                        if (chairNumber !== 0) {
                                                            toast.warning("select the seats needed!", {
                                                                theme: "dark",
                                                                position: "top-center"
                                                            })
                                                        } else {
